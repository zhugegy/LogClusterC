 ...
 */
/* 
 * File:   free_resource.h
 * 
 * Content: Declarations of global functions in free_resource.c .
 *
 * Created on November 29, 2016, 11:09 PM
 */

#ifndef FREE_RESOURCE_H
#define FREE_RESOURCE_H
